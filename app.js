(() => {
  ...
  const esNext = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-next"
  );
  const esPrev = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-prev"
  );

  const esNext2 = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-next2"
  );
  const esPrev2 = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-prev2"
  );

  const esNext3 = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-next3"
  );
  const esPrev3 = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-prev3"
  );

  const esNext4 = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-next4"
  );
  const esPrev4 = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-prev4"
  );

  const esNext5 = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-next5"
  );
  const esPrev5 = document.querySelector(
  ...
  const calculatorSubmitBtn = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-calculator__submitBtn"
  );
  const calculatorReturnBtn = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-calculator__returnBtn"
  );

  const calculatorInputsCtn = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-calculator__ctn--inputs"
  );
  const calculatorResultsCtn = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-calculator__ctn--results"
  );
  ...
  const showCalculatorResults = (input, result) => {
    ...
    const daysLeft = Math.floor(
      amountLeft / doseMatrix[data.variant][data.age].dose
    );
    const endDate = new Date(new Date().getTime() + 86400000 * daysLeft);
    const endDateFormatted = new Intl.DateTimeFormat("pl", {
      year: "numeric",
      month: "2-digit",
      day: "2-digit",
    ...
    document.querySelector(
      "#es-sanofi.es-sanofi #es-magne.es-magne .es-calculator__result--tabs"
    ).innerHTML = doseMatrix[data.variant][data.age].text;
    document.querySelector(
      "#es-sanofi.es-sanofi #es-magne.es-magne .es-calculator__result--data-container"
    ).innerHTML = "";
    for (let i in endDateFormatted) {
      document.querySelector(
        "#es-sanofi.es-sanofi #es-magne.es-magne .es-calculator__result--data-container"
      ).innerHTML += endDateFormatted[i].value;
    }
  };
  ...
  calculatorSubmitBtn.addEventListener("click", () =>
    showCalculatorResults(calculatorInputsCtn, calculatorResultsCtn)
  );
  calculatorReturnBtn.addEventListener("click", () =>
    returnToCalculator(calculatorInputsCtn, calculatorResultsCtn)
  );
  ...
  const magnifierGlass = document.querySelector(
    "#es-sanofi.es-sanofi #es-magne.es-magne .es-symptoms__magnifierGlass"
  );
  ...
  function esMagnifyNextItem() {
    ...
    const allItems = document.querySelectorAll(
      "#es-sanofi.es-sanofi #es-magne.es-magne .es-symptoms__contentCtn .es-symptoms__singleItem"
    );
    const allZoomImages = document.querySelectorAll(
      "#es-sanofi.es-sanofi #es-magne.es-magne .es-symptoms__magnifierGlass img"
    );
